...
java -cp 'target/dependency/*' -jar target/teispeechtools-0.2-SNAPSHOT.jar -i "Input-correct-from-Spec-indent.xml" -o "Input-correct-from-Spec-indent-segmented".xml segmentize
